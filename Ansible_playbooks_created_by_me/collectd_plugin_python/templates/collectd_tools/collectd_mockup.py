...
class Values:
    ...
    def dispatch(self):
        print "plugin/plugin_instance/type/type_instance: %s/%s/%s/%s =  %s" % (
...
#    config_callback(Config(key='solr_url', values=('http://10.20.16.61:8983',)))
#    config_callback(Config(key='jolokia_url', values=('http://10.20.16.61:8778/jolokia/',)))
